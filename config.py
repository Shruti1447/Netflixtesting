...
BOT_USERNAME = getenv("BOT_USERNAME", "NetflixMusicRobot")
BOT_NAME = getenv("BOT_NAME", "˹𝐀ɴɴɪᴇ ✘ 𝙼ᴜsɪᴄ˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "musicxshrushthi")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/doraemon890/NETFLIXMUSIC")
