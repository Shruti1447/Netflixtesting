...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Shrushthi_25")
BOT_USERNAME = getenv("BOT_USERNAME", "Netflix_Musicbot")
BOT_NAME = getenv("BOT_NAME", "˹Netflix Music˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "Netflix Music")
EVALOP = list(map(int, getenv("EVALOP", "7908848946").split()))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Shruti1447/NETFLIXMUSIC")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support and contact information - Provide your own support channels
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Beats_Support")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Beat_Support")
...
PING_VID_URL = getenv(
    "PING_VID_URL", "https://envs.sh/hku.jp"
)
PLAYLIST_IMG_URL = "https://envs.sh/hke.jpg"
STATS_VID_URL = "https://envs.sh/tre.mp4"
