...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("NETFLIXMUSIC/assets/thumb/font2.ttf", 30)
    font = ImageFont.truetype("NETFLIXMUSIC/assets/thumb/font.ttf", 30)
    title_font = ImageFont.truetype("NETFLIXMUSIC/assets/thumb/font3.ttf", 45)
    ...
    play_icons = Image.open("NETFLIXMUSIC/assets/thumb/play_icons.png")
