...
shrushthiphoto = [
    "https://envs.sh/tay.jpg",
    "https://envs.sh/ta6.jpg",
    "https://envs.sh/tay.jpg",
    "https://envs.sh/ta6.jpg"
]


bg_path = "NETFLIXMUSIC/assets/shrushthi/NetflixNinfo.png"
font_path = "NETFLIXMUSIC/assets/shrushthi/shrushthiinf.ttf"
...
async def userinfo(client: Client, message: Message):
    ...
    try:
        ...
        if target_user.photo:
            ...
            welcome_photo = random.choice(shrushthiphoto)
            await app.send_photo(
                chat_id,
                photo=welcome_photo,
                caption=INFO_TEXT.format(
