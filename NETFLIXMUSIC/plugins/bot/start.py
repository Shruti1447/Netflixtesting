...
from NETFLIXMUSIC.utils.inline.start import private_panel, start_panel
from NETFLIXMUSIC.utils.inline.help import first_page
from config import BANNED_USERS, AYUV, START_IMG_URL
from strings import get_string

NETFLIX_VID = [
    "https://envs.sh/taW.mp4",
    "https://envs.sh/tre.mp4",
    "https://envs.sh/t6F.mp4",
    "https://envs.sh/t6b.mp4",
    "https://envs.sh/t6P.mp4",
    "https://envs.sh/t6w.mp4",
    "https://envs.sh/t6q.mp4",
    "https://envs.sh/t6S.mp4",
    "https://envs.sh/t6W.mp4",
    "https://envs.sh/trt.mp4"
]
        ...
        if name[0:4] == "help":
            ...
            if await is_on_off(2):
                await app.send_message(
                    ...
                    text=f"{message.from_user.mention} Just Started the Bot To Check <b>sᴜᴅᴏʟɪsᴛ</b>.\n\n<b>User ID :</b> <code>{message.from_user.id}</code>\n<b>UserName :</b> @{message.from_user.username}",
                )
        elif name[0:3] == "inf":
